      ...
      <nav className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
            ...
            <div className="relative group">
              <button className="flex items-center gap-1 text-black hover:text-blue-600 font-medium transition-colors">
                ...
                <svg
                  ...
                  className="lucide lucide-chevron-down h-4 w-4 transition-transform group-hover:rotate-180"
                >
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            <button
              className="inline-flex items-center justify-center whitespace-nowrap text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 bg-black text-white hover:bg-gray-800 font-semibold px-6 py-3 rounded-lg transition-colors"
              data-track-event="cta_click"
              data-cta-id="nav-get-started-desktop"
